...
% url(URL, Count, Code, Date, Category, Title, Description).
...
url:url("https://twitter.com", 2, 200, date(2022, 4, 10), chat, no, no).
...
url:url("https://whatsapp.com", 2, 200, date(2022, 4, 10), chat, 'WhatsApp', no).
